...
Command + S で変更を同期してからメッセージ、コミット

React で作成したファイルをブラウザで確認する
　　　　　　　　　　　↓
フォルダ内のターミナルでローカルホストを起動する　npm run dev
                　　↓
index.html をブラウザにDr&Pa
　　　　　　　　　　　↓
